        ...
        return {
            ...
            createHTableTags: function(node){
                ...
                this.parseNodeAttributes(params,node,["class","style","region","design","gutters","title","iconClass",
                    "readOnly","wordWrap","allowFillHandle","useFilters"]);
            ...
            parseContainer: function(ind,containerNode,$page, startupList){
                ...
                if(!containerChild
                    ||containerNode.tagName=="HTableSimpleFiltered".toUpperCase()
                    ||containerNode.tagName=="HTableSimpleFiltered".toUpperCase())return;                   //log('tagParser.parseContainer: containerChild=', containerChild,containerChild.tagName,containerChild.id);
